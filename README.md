...
- [`docs/design/scroll-driven-image-motion-chapters.md`](./docs/design/scroll-driven-image-motion-chapters.md) — detailed lotus-bloom case study, consecutive photographic motion chapters, image handoffs, macro-to-product transitions, rhythm, and the recommended first photographic experiment
